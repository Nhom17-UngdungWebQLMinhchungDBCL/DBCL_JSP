				...
				<ul class="nav nav-tabs" role="tablist">
                   	...
                   	<span class="caret"></span></a> 
    					         <ul class="dropdown-menu">
    					           <li><a href="TaoThemMC.jsp" target="_blank">Tạo thêm Minh chưng</a></li>
...
<div class="row">
  ...
  <div class="panel-body">
         <p><h4>Minh chứng chất lượng bài giảng:</h4></p>
         <p><img src="hinh/Su Mang 1.png" alt=""></p>
         <p><img src="hinh/Su Mang 2.png" alt=""></p>
       <label class="control-label col-md-4"><button type="submit" class="btn btn-default"><a href="ListGui_BCN.jsp">Download</a></button></label> 
