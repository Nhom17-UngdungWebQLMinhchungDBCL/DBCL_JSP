         ...
         <table class="table table-bordered">
          ...
          <tbody>
               <tr>
                  ...
                  <td><button type="submit" class="btn btn-info"><a href="XemFile1.jsp">Xem</a></button></td>
              </tr>
          </tbody>
           <tbody>
               <tr>
                 <td>Minh chứng Chất lượng đồ án</td>
                  ...
                  <td><button type="submit" class="btn btn-info"><a href="XemFile2.jsp">Xem</a></button></td>
           ...
           <tbody>
               <tr>
                 <td>Minh chứng Chất lượng bài giảng</td>
                  ...
                  <td><button type="submit" class="btn btn-info"><a href="XemFile3.jsp">Xem</a></button></td>
