...
<div class="container">
  ...
  <div class="panel-heading"><h4>Thông Tin Ban Kiểm Định</h4></div>
  ...
  <div class="col-md-offset-1 col-md-10">
			...
			<img src="hinh/Hinh_BKD.PNG" alt="" class="pull-left"  width="118" height="118">
				...
				<table class="table table-condensed">
					<tbody>
						...
						<tr>
							...
							<center><td><button type="submit" class="btn btn-default"><a href="ThongTin_BKD.jsp">Submit</a></button></td></center>
