...
<div class="container">
  ...
  <div class="panel-heading">Danh sách Đã Xuất</div>
       ...
       <table class="table table-bordered">
          ...
          <tbody>
               <tr>
                  ...
                  <td><button type="submit" class="btn btn-info"><a href="XemFile1_BCN.jsp">Xem</a></button></td>
              </tr>
          </tbody>
           <tbody>
               <tr>
                 <td>Minh chứng Chất lượng đồ án</td>
                  ...
                  <td><button type="submit" class="btn btn-info"><a href="XemFile2_BCN.jsp">Xem</a></button></td>
           ...
           <tbody>
               <tr>
                 <td>Minh chứng Chất lượng bài giảng</td>
                  ...
                  <td><button type="submit" class="btn btn-info"><a href="XemFile3_BCN.jsp">Xem</a></button></td>
