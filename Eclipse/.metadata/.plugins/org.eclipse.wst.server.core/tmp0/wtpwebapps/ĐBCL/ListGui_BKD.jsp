  ...
  <div class="row" >    
      <div class="col-md-offset-1 col-md-10">
        ...
        <ul class="nav nav-tabs" role="tablist">
         ...
         <p><h5>KĐV. Nguyễn Văn A</h5></p>
             <button type="submit" class="btn btn-info"><a href="TrangChu.html">Thoát</a></button>
       </div>
      </div>
 </div>
</div>
...
<div class="container">
  ...
  <div class="panel-heading">Danh sách Minh chứng Đã xem:</div>
       ...
       <table class="table table-bordered">
          ...
          <tbody>
               <tr>
                  ...
                  <td><button type="submit" class="btn btn-info"><a href="GuiFile_BKD.jsp">Gửi</a></button></td>
              </tr>
          </tbody>
           <tbody>
               <tr>
