...
<div class="container">
  ...
  <div class="col-md-offset-1 col-md-10">
			...
			<img src="hinh/Hinh_GV.PNG" alt="" class="pull-left"  width="118" height="118">
				...
				<table class="table table-condensed">
					<tbody>
						...
						<tr>
							...
							<center><td><button type="submit" class="btn btn-default"><a href="Update_GV.jsp">Cập Nhật</a></button></td></center>
